...
public class EsyaPostsActivity extends AppCompatActivity {
    ...
    public void init() {
        backButton2 = (ImageButton) findViewById(R.id.esya_geri);
        SelecPostImage2 = (ImageView) findViewById(R.id.esya_post_imageButton);
        UpdatePostButton2 = (Button) findViewById(R.id.esya_post_button);
        PostDescription2 = (EditText) findViewById(R.id.esya_post_editText);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esya_posts);
        init();
        ...
        backButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent = new Intent(EsyaPostsActivity.this, EsyaActivity.class);
        ...
        if (ImageUri2 != null) {
            ...
            uploadTask2.continueWithTask(new Continuation() {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        usersReference.child(current_user_id2).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                hashMap.put("esya_postid", current_user_id2);
                                hashMap.put("esya_date", saveCurrentDate2);
                                hashMap.put("esya_time", saveCurrentTime2);
                                hashMap.put("esya_postimage", myUrl);

                                hashMap.put("username", userFullname);
                                hashMap.put("esya_description", PostDescription2.getText().toString());
                                hashMap.put("esya_publisher", mAuth.getCurrentUser().getUid());
                                postsRef1.child(current_user_id2 + postRandom2).setValue(hashMap);
                                progressDialog.show();
                                startActivity(new Intent(EsyaPostsActivity.this, EsyaActivity.class));
                                finish();
                        ...
                        Toast.makeText(EsyaPostsActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(EsyaPostsActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void StoringImageToFirebaseStoronge() {
        ...
        FilePath.putFile(ImageUri2).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(EsyaPostsActivity.this, "Görüntü Başarılı Bir Şekilde Yüklendi...", Toast.LENGTH_SHORT).show();
                } else {
                    String message = task.getException().getMessage();
                    Toast.makeText(EsyaPostsActivity.this, "Hata Oluştu" + message, Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Toast.makeText(EsyaPostsActivity.this, "Hata", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(EsyaPostsActivity.this, EsyaActivity.class));
